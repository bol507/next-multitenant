...
export const SearchFilters = () => {
  ...
  const activeSubcategoryData = activeCategoryData?.subcategories?.find((subcategory) => subcategory.slug === activeSubcategory)
  const activeSubcategoryName = activeSubcategoryData?.name || null

  return (
    <div 
      className="px-4 lg:px-2 py-8 border-b flex flex-col gap-4 w-full"
