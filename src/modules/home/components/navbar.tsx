  ...
  return (
    <nav className="h-20 flex border-b justify-between font-medium bg-white">
      ...
      <div className="hidden  lg:flex ">
        ...
        <Button
          asChild
          className="border-l border-t-0 border-b-0 border-r-0 px-12 h-full rounded-none bg-black text-white hover:bg-pink-500 hover:text-black transition-colors text-lg"
        >
          <Link href="/sign-up">
            Start selling
          </Link>
